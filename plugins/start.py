...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        ...
        if not is_user_pro and user_id != OWNER_ID and not is_short_link and shortner_enabled:
            ...
            tutorial_link = getattr(client, 'tutorial_link', "https://t.me/Heisenbergbackupzone")
            ...
            await client.send_photo(
                ...
                reply_markup=InlineKeyboardMarkup([
                    ...
                    [
                        InlineKeyboardButton(" • ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ •", url="t.me/Heisenbergsells")
                    ]
                ])
            )
